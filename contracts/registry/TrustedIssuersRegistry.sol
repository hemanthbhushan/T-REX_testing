 ...
 */
 //this is like the in the video mentioned
...
contract TrustedIssuersRegistry is ITrustedIssuersRegistry, Ownable {
    ...
    //ecach trustedissuer will have certain claimTopics like   1faceboook email pancard etc those will stored below 
    ...
    function removeTrustedIssuer(IClaimIssuer _trustedIssuer) external override onlyOwner {
        require(trustedIssuerClaimTopics[address(_trustedIssuer)].length != 0, "trusted Issuer doesnt exist");
